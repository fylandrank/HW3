...
cp_use<-read_csv("../data/contraceptive_use.csv")
```
...
### Input `dat` does NOT contain variable iso, year and/or contraceptive_use_modern
...
Paste your link here...https://github.com/fylandrank/HW3
